...
export const getAllUsers=async(pageNo:string,pageSize:string)=>{
    ...
    try {
        const res = await fetch(`${process.env.SERVER_URL}/admin/users?pageNo=${pageNo}&pageSize=${pageSize}`,{
            method:"GET",
            headers:{
...
export const getAllPremiumUsers=async(pageNo:string,pageSize:string)=>{
    try {
        const res = await fetch(`${process.env.SERVER_URL}/admin/getPremiumUsers?pageNo=${pageNo}&pageSize=${pageSize}`,{
            method:"GET",
            headers:{
                "Content-Type":"application/json"
            },
...
export const getNotesAndPYQS = async(id:string)=>{
    try {
        const res = await fetch(`${process.env.SERVER_URL}/notes/getNotesAndPYQS/${id}`,{
            method:"GET",
            headers:{
                "Content-Type":"application/json"
            },
...
export const assignSubjectToSemester =async(subjectId:string,semesterId:string)=>{
    try {
        const res =await fetch(`${process.env.SERVER_URL}/notes/addSubjectToSemester`,{
            method:"POST",
            headers:{
                "Content-Type":"application/json"
            },
...
export const removeSubjectFromSemester =async(subjectId:string,semesterId:string)=>{
    try {
        const res =await fetch(`${process.env.SERVER_URL}/notes/removeSubjectFromSemester`,{
            method:"POST",
            headers:{
                "Content-Type":"application/json"
            },
...
export const fetchFaculties = async () => {
    try {
        const res = await fetch("${process.env.SERVER_URL}/faculties-review/getFacultiesIdsAndName", {
            method: "GET",
            headers: {
                "Content-Type": "application/json"
            },
...
export const assignSubjectToFacultyToDb=async(data:{
    ...
    try {
        const res = await fetch(`${process.env.SERVER_URL}/faculties-review/assignSubjectToFaculty`,{
            method:"POST",
            headers:{
                'Content-Type':"application/json"
            },
    ...
    export const assignSectionToFacultyToDb=async(data:{
        ...
        try {
            const res = await fetch(`${process.env.SERVER_URL}/faculties-review/assignSectionToFaculty`,{
                method:"POST",
                headers:{
                    'Content-Type':"application/json"
                },
