...
import HideLink from './Academic/hideLink'

const ShowingContents = ({id}:{id:string}) => {
    useEffect(()=>{
  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen z-50 overflow-y-hidden  ">
             <HideLink/>
...
export default ShowingContents