...
const Sidebar = () => {
  ...
  return (
    <div className={`w-1/6   ${!sidebar && "hidden" }  bg-body rounded-md text-white  h-screen min-h-screen  sticky top-0 overflow-y-auto`}>
      <nav
        className={` min-h-full  shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300
        ...
        <div className="h-full text-white ">
          ...
          <div className="text-white">
            <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
              ...
              <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 py-3 px-7 font-extrabold uppercase  bg-opacity-[0.08]">
                <svg
              ...
              <li className="nav-item ">
                <ul className="flex gap-3 text-[15px] flex-col">
                  <li className="nav-item hover:bg-gray-800 rounded-md py-2 px-2">
                    <Link href="/Admin/subjects" className="group">
                      <div className="flex items-center gap-3 ">
                        ...
                        <span className="ltr:pl-3 rtl:pr-3 text-[#506690] dark:group-hover:text-white-dark">
                          {t("Subjects")}
                        </span>
                      </div>
                    </Link>
              ...
              <li className="nav-item ">
                <ul className="flex gap-3 text-[15px] flex-col">
                  <li className="nav-item hover:bg-gray-800 rounded-md py-2 px-2">
                    <Link href={`/Admin/semester?semester=6&branch=CSE`} className="group">
                      <div className="flex items-center gap-3 ">
                        <svg
                          className="group-hover:!text-blue-500"
                          width="20"
